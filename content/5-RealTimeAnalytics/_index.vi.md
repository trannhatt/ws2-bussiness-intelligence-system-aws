...
- [5.3 Tạo và cấu hình AWS Lambda Function](5.3-CreateLambdaFunction/)
- [5.4 Kích hoạt AWS Lambda Function để nhập bản ghi vào Amazon OpenSearch](5.4-EnableLambdaFunction/)
- [5.5 Trực quan hóa dữ liệu với Kibana](5.5-DataVisualizationKibana/)
